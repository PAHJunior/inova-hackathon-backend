module.exports = {
  ...
  rules: {
    ...
    'unicorn/catch-error-name': ['off'], // Allow using 'e' on catch instead of 'error'
    ...
    'unicorn/no-unsafe-regex': ['error'], // Prevent regex that may lead to catastrophic backtracking
